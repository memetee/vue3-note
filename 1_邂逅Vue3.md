...
![image-20240805213807159](./1_邂逅Vue3.assets/image-20240805213807159.png)

### 目前Vue在前端处于什么地位？

目前前端最流行的是三大框架：Vue、React、Angular。

![image-20250717133212760](./1_邂逅Vue3.assets/image-20250717133212760.png)



### 框架数据对比（Google指数）

![image-20250717133244049](./1_邂逅Vue3.assets/image-20250717133244049.png)



### 框架数据对比（百度指数）

![image-20250717133258068](./1_邂逅Vue3.assets/image-20250717133258068.png)

### 框架数据对比（npm下载量）

![image-20250717133310506](./1_邂逅Vue3.assets/image-20250717133310506.png)

### 框架数据对比（GitHub）

![image-20250717133321729](./1_邂逅Vue3.assets/image-20250717133321729.png)
...
![image-20250717133335478](./1_邂逅Vue3.assets/image-20250717133335478.png)
...
![cdn的理解](./1_邂逅Vue3.assets/cdn的理解.png)

![image-20220528110120097](./1_邂逅Vue3.assets/image-20220528110120097.png)
...
![image-20250717140347476](./1_邂逅Vue3.assets/image-20250717140347476.png)

mvc

![image-20250717140756159](./1_邂逅Vue3.assets/image-20250717140756159.png)
...
![image-20250717140144780](./1_邂逅Vue3.assets/image-20250717140144780.png)

给它声明好，然后绑定

mvvm

![image-20250717141031129](./1_邂逅Vue3.assets/image-20250717141031129.png)
...
![image-20250717134435656](./1_邂逅Vue3.assets/image-20250717134435656.png)
...
![image-20250717134448004](./1_邂逅Vue3.assets/image-20250717134448004.png)
...
![image-20250717134503860](./1_邂逅Vue3.assets/image-20250717134503860.png)
...
![image-20250717162749614](./1_邂逅Vue3.assets/image-20250717162749614.png)

2、执行这个命令，它会把packge文件夹里面的源码做一个打包，打包之后的源码放到**packge/vue**文件夹下的**dist**文件夹

![image-20250717163050654](./1_邂逅Vue3.assets/image-20250717163050654.png)

这个就是vue的源码，也是cdn看到的源码。

3、调试源码。

![image-20250717163322228](./1_邂逅Vue3.assets/image-20250717163322228.png)



4、如何查看源码在哪个具体文件夹或文件

![image-20250717163342481](./1_邂逅Vue3.assets/image-20250717163342481.png)

![image-20250717163424427](./1_邂逅Vue3.assets/image-20250717163424427.png)
...
![image-20250717163520598](./1_邂逅Vue3.assets/image-20250717163520598.png)
...
![image-20250717163703327](./1_邂逅Vue3.assets/image-20250717163703327.png)
...
![image-20250717163800789](./1_邂逅Vue3.assets/image-20250717163800789.png)



我们就可以在这里找到

![image-20250717163848308](./1_邂逅Vue3.assets/image-20250717163848308.png)
